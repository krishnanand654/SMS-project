...
function edit_program_action(admit_id, msg = "") {
  ...
  if (msg == "updatee")
    document.getElementById("msg").innerHTML =
      "<center>Secesscessfully Update</center>";
...
function loader(divname) {
  document.getElementById(divname).innerHTML =
    "<center><img style='margin-top:35px' src='http://localhost/project/youth/upload/site_content/processing1.gif' /></center>";
}
...
window.success = function (msg) {
  var dom =
    '<div class="top-alert"><div class="alert alert-success-alt alert-dismissable fade in " role="alert"><i class="glyphicon glyphicon-ok"></i> ' +
    msg +
