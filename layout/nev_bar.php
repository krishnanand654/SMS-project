...
?>
<script src="https://kit.fontawesome.com/7750bf4231.js" crossorigin="anonymous"></script>
...
<script type="text/javascript" src="layout/js/nav_bar_script.js"></script>
 <div class="navbar navbar-default" role="navigation" style="position: auto; border-width: 0px 0px 1px 0px; border-color: rgba(0,0,0,0.2); padding: 10px;" >
        ...
        <ul class="nav navbar-nav navbar-left">  
          ...
          <button  class="btn_nav_toggle" style="color:white; background:none; border:none"><i class="fa fa-bars" id="icon_div"></i></button>
          
          </span> 
          
        
          <a class="" href="index.php"><span class="navbar-brand"  style="color:var(--font-color)"><font class="logo_title"> <?php #echo $db->site_name;  ?>Student Management System</font></span></a>
